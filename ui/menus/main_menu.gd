...
var options_scene = preload('res://ui/menus/options_menu.tscn')
var class_menu_scene = preload('res://ui/menus/class_menu.tscn')
var meta_menu_scene = preload('res://ui/menus/meta_menu.tscn')
...
func on_play_pressed() -> void:
	ScreenTransition.transition_to_scene('res://scenes/main.tscn', true)
